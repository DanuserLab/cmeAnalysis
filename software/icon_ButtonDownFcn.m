...
% This location fcn is to check if the ud.class is one of 18 classes used in BiosensorsPackage,
...
% This location fcn is to get url of the wiki page of Biosensors package.
switch(className)
