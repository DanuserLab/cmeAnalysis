function [trackabilityCost,sampledPredictions,sampleLabel,votingLabel,trackabilityCostFull,predExpectation]=simulatedPredictionVoting(predStat,costFunc,costMatParam,dynCostMatParam,varargin)
